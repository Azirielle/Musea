    ...
    <MainLayout>
        <div class="pt-24 pb-12 px-6 bg-[#FAF7F2]">
            <div class="max-w-7xl mx-auto">
                <h1 class="text-4xl font-bold text-[#1A1A1A] mb-8 text-center">Meet the Artists</h1>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    <div v-for="artist in artists.data" :key="artist.id" class="bg-white rounded-xl p-6 shadow-sm text-center hover:shadow-md transition">
                         <div class="w-24 h-24 mx-auto bg-gray-200 rounded-full mb-4 overflow-hidden">
                             ...
                             <img :src="`https://ui-avatars.com/api/?name=${artist.first_name}+${artist.last_name}&background=CBA35C&color=fff`" alt="Avatar" class="w-full h-full object-cover">
                         </div>
                         ...
                         <Link href="#" class="text-[#CBA35C] font-medium hover:underline">View Collection</Link>
                    </div>
                </div>
