                            ...
                            <div v-show="isProfileOpen" class="absolute right-0 mt-4 w-64 bg-white border border-divider shadow-2xl rounded-2xl py-2 z-50">
                                ...
                                <div class="py-1">
                                    <Link v-for="link in [
                                        ...
                                        ...(user.role === 'artist'
                                            ? [{ href: route('dashboard.wallet'), label: 'My Wallet', icon: 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-2m2-8h-5a2 2 0 00-2 2v6a2 2 0 002 2h5a1 1 0 001-1v-8a1 1 0 00-1-1z' }]
                                            : []),
